...
// Python backend URL — all heavy processing (OpenCV, FFmpeg, CLIP) runs there
...
export async function POST(req: NextRequest) {
  try {
    ...
    // -----------------------------------------------------------------------
    // Step 3: Run analysis — backend handles OpenCV keyframe extraction,
    //         motion filtering, and (when connected) CLIP similarity scoring.
    //         The temporal smoother then bridges confidence dips into
    //         continuous clip ranges.
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // Step 4: Map backend response to the AuditResponse schema the
    //         dashboard expects
    // -----------------------------------------------------------------------
